...
Аналогично с заданием 1 редактируем файл `inventory.ini`
```
[all]
...
Для настроек keepalived отредактируем файл [inventory/mycluster/group_vars/k8s_cluster/k8s-cluster.yml](), добавив ткда следующий раздел
```
